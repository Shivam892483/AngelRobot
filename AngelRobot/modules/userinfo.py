...
import AngelRobot.modules.sql.userinfo_sql as sql
...
from AngelRobot.__main__ import STATS, TOKEN, USER_INFO
from AngelRobot.modules.disable import DisableAbleCommandHandler
from AngelRobot.modules.helper_funcs.chat_status import sudo_plus
from AngelRobot.modules.helper_funcs.extraction import extract_user
from AngelRobot.modules.sql.global_bans_sql import is_user_gbanned
from AngelRobot.modules.sql.users_sql import get_user_num_chats
            ...
            message.reply_photo(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "ʜᴇᴀʟᴛʜ", url="https://t.me/AngelAssociation/7"
                            ),
                            InlineKeyboardButton(
                                "ᴅɪꜱᴀꜱᴛᴇʀ", url="https://t.me/AngelAssociation/8"
                            ),
                        ],
                    ]
                ),
