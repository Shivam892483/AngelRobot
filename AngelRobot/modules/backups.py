...
# from AngelRobot.modules.sql import warns_sql as warnssql
import AngelRobot.modules.sql.blacklist_sql as blacklistsql

# from AngelRobot.modules.sql import cust_filters_sql as filtersql
# import AngelRobot.modules.sql.welcome_sql as welcsql
import AngelRobot.modules.sql.locks_sql as locksql
import AngelRobot.modules.sql.notes_sql as sql

# from AngelRobot.modules.rules import get_rules
import AngelRobot.modules.sql.rules_sql as rulessql
from AngelRobot import EVENT_LOGS, LOGGER, OWNER_ID, SUPPORT_CHAT, dispatcher
from AngelRobot.__main__ import DATA_IMPORT
from AngelRobot.modules.connection import connected
from AngelRobot.modules.helper_funcs.alternate import typing_action
from AngelRobot.modules.helper_funcs.chat_status import user_admin
from AngelRobot.modules.sql import disable_sql as disabledsql
...
def export_data(update, context):
    ...
    with open("AngelRobot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("AngelRobot{}.backup".format(chat_id), "rb"),
        caption="📤*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `AngelRobot-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("AngelRobot{}.backup".format(chat_id))  # Cleaning file
