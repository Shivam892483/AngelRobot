...
from AngelRobot import BOT_NAME
from AngelRobot import telethn as tbot
from AngelRobot.events import register
from AngelRobot.modules.sql.night_mode_sql import (
    add_nightmode,
    get_all_chat_id,
    is_nightmode_indb,
    rmnightmode,
