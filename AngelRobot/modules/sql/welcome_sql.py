...
from AngelRobot.modules.helper_funcs.msg_types import Types
...
DEFAULT_WELCOME_MESSAGES = [
    "Welcome {first}! We’re excited to have you here",
    " Hey {First} Sending you a warm welcome from me and everyone at {SUPPORT_CHAT}. Thank you for joining us!",
    "Hey {First} Welcome to the {SUPPORT_CHAT} . I hope you will enjoy",
    "Welcome {First} ! We’re here to help, so if you need anything, just ask",
    "Delighted to have you with us {First}",
    "Welcome {First} . You’re joining a dynamic Group",
    "Thank you for joining us {First}! I believe you’ll enjoy with us",
...
DEFAULT_GOODBYE_MESSAGES = [
    "buye bye {first} .. i will not say Goodbye",
    "{first} just leaved the chat.",
    "{first} has left the lobby.",
    "{first} has left the battle.",
    "{first} has left the game.",
    "{first} has lost the challange.",
    "{first} is out of the running.",
    "Nice knowing yaa, {first}!",
    "It was a fun time {first}.",
    "We hope to see you again soon, {first}.",
    "I don't want to say goodbye, {first}.",
    "Congratulations, {first}! You're officially free from this group.",
    "{First} went to sleep",
]
